...
import { useGetPesananById } from '@/app/hooks/mutasion/pesanan/useGetPesananById';
...
const PesananContainer = () => {
  const IdPemesanan = useAppSelector((state) => state.pesanan.pesananId);
  const [isActive, setIsActive] = useState<'Aktif' | 'Riwayat' | null>('Aktif');
  const pesanan = useGetPesananById(IdPemesanan!) as unknown as { data?: SummaryResponse };
